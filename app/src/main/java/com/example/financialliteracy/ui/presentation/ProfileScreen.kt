...
fun Profile(navController: NavController) {
    val mockList = remember{
        mutableStateListOf("Edit Profile","Favorite List","FAQ","Sign Out","ABCD EFG","SEDGSED","WESDGSE","SDGSDB","SDBHSD")
    }
            ...
            LazyColumn(modifier = Modifier
                ...
                items(mockList.count()){
                    ...
                    Row(modifier = Modifier
                        ...
                        Row(modifier = Modifier
                            .fillMaxWidth()
                            .padding(horizontal = 30.dp, vertical = 20.dp), horizontalArrangement = Arrangement.SpaceBetween) {
                            Text(text = "$item", fontSize = 20.sp)
                            Icon(imageVector = Icons.Default.ArrowForward, contentDescription = "setting icon" )
